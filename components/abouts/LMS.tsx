...
const LMS = () => {
  return (
    <section className="py-10">
      <div className="grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 bg-primary/10 lg:px-16 lg:py-10 md:px-8 md:py-6 p-4 gap-6 lg:gap-20 items-center">
        <h2 className="mx-auto text-[20px] lg:text-4xl md:text-3xl font-semibold text-primary block lg:hidden md:block sm:block">
          Learning Management System
        </h2>
        <div className="mx-auto rounded-full w-90 h-90 lg:w-139.5 lg:h-142 md:w-120 md:h-120  overflow-hidden">
          <Image
            src="/images/lms.jpg"
            alt="LMS"
            width={500}
        ...
        <div>
          <h2 className="text-[20px] lg:text-4xl font-semibold text-primary hidden lg:block md:hidden sm:hidden">
            Learning Management System
          </h2>
